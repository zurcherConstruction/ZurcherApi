...
const { getBalanceDetailAnalysis } = require('../controllers/balanceDetailController');
...
router.get('/detailAnalysis', verifyToken, allowRoles(['admin', 'owner', 'finance', 'finance-viewer']), getBalanceDetailAnalysis);
